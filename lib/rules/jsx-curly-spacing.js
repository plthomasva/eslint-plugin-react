  ...
  create(context) {
    ...
    */
    ...
    function validateBraceSpacing(node) {
      ...
      if (spacing === SPACING.always) {
        if (!isSpaceBetween(sourceCode, first, second)) {
          reportRequiredBeginningSpace(node, first);
        } else if (!config.allowMultiline && isMultiline(first, second)) {
          reportNoBeginningNewline(node, first, spacing);
        }
        if (!isSpaceBetween(sourceCode, penultimate, last)) {
        ...
        } else if (isSpaceBetween(sourceCode, first, second)) {
        ...
        } else if (isSpaceBetween(sourceCode, penultimate, last)) {
